...
const ICONS = {
  ...
  health: icon('ic_healths'),
  volunteer: icon('ic_volunteer'),
  contractor: icon('ic_contractor')
};
    ...
    () => [
      ...
      // ----------------------------------------------------------------------
      {
        ...
        items: [
          ...
          {
            title: t('Health & Wellness Portal'),
            path: paths.dashboard.general.health,
            icon: ICONS.health,
          },
          {
            title: t('Volunteer Portal'),
            path: paths.dashboard.general.volunteer,
            icon: ICONS.volunteer,
          },
          {
            title: t('Contractor Portal'),
            path: paths.dashboard.general.contractor,
